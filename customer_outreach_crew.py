...
class SentimentAnalysisTool(BaseTool):
    ...
    def _run(self, text: str) -> str:
        # Custom code tool goes here
        # Will just return positive for now, but could use a model
        # that can classify sentiment
        return "positive"
...
inputs = {
    "lead_name": "Scandinavian CRO",
    "industry": "Contract Research Organizations",
    "key_decision_maker": "Joakim AI",
    "position": "CEO",
...
filename = f"outputs/customer_outreach_result_{timestamp}.md"

# Save the FINAL result as Markdown (after both agents complete)
with open(filename, "w", encoding="utf-8") as f:
    f.write("# Customer Outreach Crew Result\n\n")
    f.write(f"**Generated:** {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n\n")
    f.write("---\n\n")
    f.write("## Final Outreach Campaign\n\n")
    f.write("This result has been generated by both the Sales Representative and Lead Sales Representative agents.\n\n")
    f.write("---\n\n")
    f.write(result)

print(f"\n✅ FINAL RESULT saved as Markdown file: {filename}")
print("📋 This file contains the complete outreach campaign after both agents completed their tasks.")
