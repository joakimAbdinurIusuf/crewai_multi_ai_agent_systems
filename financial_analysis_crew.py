...
print("📊 Analyzing MSFT (Microsoft) stock with Medium risk tolerance")
print("⏳ This execution will take some time to run...\n")
...
filename = f"outputs/financial_analysis_result_{timestamp}.md"

# Save the FINAL result as Markdown (after all agents complete)
with open(filename, "w", encoding="utf-8") as f:
    f.write("# Financial Analysis Crew Result\n\n")
    f.write(f"**Generated:** {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n\n")
    f.write("---\n\n")
    f.write("## Financial Analysis Summary\n\n")
    f.write("This result has been generated by the Data Analyst, Trading Strategy Developer, ")
    f.write("Trade Advisor, and Risk Advisor agents working together.\n\n")
    f.write("---\n\n")
    f.write(result)
...
try:
    ...
    print("IPython display not available, result saved as Markdown above")
